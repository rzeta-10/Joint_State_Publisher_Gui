...
class JointStatePublisherGUI:
    def __init__(self):
        ...
        self.joint_velocities = [0.0] * (len(self.joint_names) - 1)  # Velocity only for joint1 to joint4
    ...
    def create_gui(self):
        ...
        self.velocity_scale_vars = [tk.DoubleVar(value=0.0) for _ in range(len(self.joint_names) - 1)]
    ...
    def update_values(self, event):
        ...
        if key.isdigit():
            ...
            if 0 <= index < len(self.joint_names):
                ...
                if index < len(self.joint_names) - 1:
